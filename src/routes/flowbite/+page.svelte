...
<div class="mx-auto max-w-6xl p-4">
  <h1 class="my-4 text-2xl font-bold">Svelte Animated Icons: Flowbite Icons</h1>
  ...
  <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
    {#each filteredIcons as [name, Icon] (name)}
      ...
      >
        ...
        <button
          class="copy-badge absolute top-2 right-2 rounded bg-gray-800 px-2 py-1 text-xs text-white opacity-0 transition-opacity group-hover:opacity-100"
