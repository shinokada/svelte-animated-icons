...
{#if event === 'onmouseenter'}
	<button onmouseenter={handleEvent}>
     ...
     transition:draw={shouldAnimate ? transitionParams : undefined} stroke-linecap="round" stroke-linejoin="round"/> <path d="M6 6H6.0075V6.0075H6V6Z" stroke={color} stroke-width={strokeWidth} 
