...
{#if event === 'onmouseenter'}
	<button onmouseenter={handleEvent}>
     ...
     transition:draw={shouldAnimate ? transitionParams : undefined} stroke-linecap="round" stroke-linejoin="round"/> <path d="M15 12C15 13.6568 13.6569 15 12 15C10.3431 15 9 13.6568 9 12C9 10.3431 10.3431 8.99999 12 8.99999C13.6569 8.99999 15 10.3431 15 12Z" stroke={color} stroke-width={strokeWidth} 
